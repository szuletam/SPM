module ReportsControllerPatch
	def self.included(base) # :nodoc:
		...
		base.class_eval do
			alias_method_chain :issue_report, :modification
			alias_method_chain :issue_report_details, :modification
		end

	end

	module InstanceMethods
		def issue_report_with_modification
			...
			@issues_by_direction = Issue.by_direction(@project) || []

			render :template => "reports/issue_report"
    end

    def issue_report_details_with_modification
      case params[:detail]
        when "tracker"
          @field = "tracker_id"
        ...
        when "direction"
          @field = "direction_id"
          @rows = Direction.all.sort
          @data =  Issue.by_direction(@project) || []
