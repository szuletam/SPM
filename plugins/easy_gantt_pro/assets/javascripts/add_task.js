...
ysy.view.extender(ysy.view.Widget, ysy.view.AddTaskPanel, {
...
$.extend(ysy.pro.addTask, {
  ...
  getIdByLine: function (line, type) {
    ...
    for (var i = 0; i < allowed.length; i++) {
      if (task.type === allowed[i]) {
        return {id: task.real_id, type: task.type, project_id: task.widget.model.project_id};
      }
    }
