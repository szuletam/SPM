...
Redmine::MenuManager.map :top_menu do |menu|
  ...
  menu.push :help, :helps_aig_path, :last => true
end
...
Redmine::MenuManager.map :project_menu do |menu|
  ...
  menu.push :new_file, {:controller => 'files', :action => 'new'}, :param => :project_id, :caption => :label_attachment_new,
              :parent => :new_object
  menu.push :overview, { :controller => 'projects', :action => 'show' }, :if  => Proc.new { |p| p.overview? }
  menu.push :activity, { :controller => 'activities', :action => 'index' }, :if  => Proc.new { |p| p.activity? }
